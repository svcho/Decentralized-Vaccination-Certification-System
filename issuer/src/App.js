...
function InputTargetDIDTextField() {
  return (
    <div class="row">
      <div class="col-3">
...
function IssueVerifiableCredentialButton() {
  return (
    <div class="row">
      <div class="col">
...
function IssuedCredentialDisplay() {
  return (
    <div class="row">
      <div class="col">
  ...
  return (
    <div className="App">
      <div class="container">
        <Header />
        <VaccineList />
        <InputTargetDIDTextField />
        <IssueVerifiableCredentialButton />
        <IssuedCredentialDisplay />
      </div>
    </div>
  );
}
